(module
 ...
 (data (i32.const 256) "^\00\00\00\01\00\00\00\01\00\00\00^\00\00\00I\00N\00V\00A\00L\00I\00D\00 \00n\00B\00o\00d\00y\00F\00o\00r\00c\00e\00s\00 \00p\00a\00r\00a\00m\00e\00t\00e\00r\00.\00 \00 \00C\00h\00a\00o\00s\00 \00e\00n\00s\00u\00e\00s\00.\00.\00.\00")
 ...
 (func $~lib/typedarray/Float64Array#get:length (; 29 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
 ...
 (func $~lib/typedarray/Float64Array#__get (; 33 ;) (type $FUNCSIG$dii) (param $0 i32) (param $1 i32) (result f64)
  local.get $1
  local.get $0
  i32.load offset=8
  i32.const 3
 ...
 (func $~lib/array/Array<f64>#constructor (; 34 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $6 i32)
  local.get $0
  if
   local.get $0
 ...
 (func $nBodyForces/nBodyForces (; 45 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  ...
  i32.const 0
  local.get $1
  global.get $nBodyForces/forceSize
  i32.mul
